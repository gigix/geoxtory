...
(function(){
 var   gsearch_css='../stylesheets/googlebar.css', // You need to edit this so it it points to your version of the default.css
 ...
 LocalSearch.prototype['createResultHtml']=function(result){
  result['html']=createDiv('gs-result gs-localResult',[
												   ...
												   createDiv('gs-latlng', [result['lat'] + "," + result['lng']]),
